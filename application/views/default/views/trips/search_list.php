...
if ($this->input->post('departure_point')) {
    $v .= "&departure_point=" . $this->input->post('departure_point');
}
if ($this->input->post('arrival_point')) {
    $v .= "&arrival_point=" . $this->input->post('arrival_point');
}
...
<script>
    $(document).ready(function () {
        $('#CuData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('trips/get_trips'. $v) ?>',
